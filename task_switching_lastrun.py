...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\fuchi\\Documents\\PsychoPy\\Task_switching\\task_switching_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisInstruction_Loop in Instruction_Loop:
        ...
        # keep track of which components have finished
        InstructionComponents = [key_resp, back_img, instr_image]
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    ReadyNumbersComponents = [back_img_6, Instr_numbers_Only, key_resp_2]
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        NumberTask_PracticeComponents = [back_img_2, grid, NumberStim, NumberResponse]
    ...
    _key_resp_3_allKeys = []
    # keep track of which components have finished
    ReadyLettersComponents = [back_img_7, Readyletter_img, key_resp_3]
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        LetterTask_PracticeComponents = [back_img_5, grid_3, LetterStim, LetterResponse]
    ...
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    ReadyMixedComponents = [back_img_9, ReadyMix_img, key_resp_4]
    ...
    for thisBlock in Block:
        ...
        for thisTrial_3 in trials_3:
            ...
            # keep track of which components have finished
            Mixed_TaskComponents = [back_img_4, grid_2, Task_switch_stim, MixedResponse]
            ...
            RT_list.append(MixedResponse.rt)
